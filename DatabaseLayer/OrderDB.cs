...
namespace OrderSystem.DatabaseLayer
{
    public class OrderDB : DB
    {
        ...
        private void Create_INSERT_Command(Order anOrder)
        {
            ...
            daMain.InsertCommand = new SqlCommand("INSERT into Orders (OrderID, CustomerID, OrderDate, TotalCost, OrderStatus) VALUES (@OrderID, @CustomerID, @OrderDate, @TotalCost, @OrderStatus)", cnMain);
        ...
        private void Create_UPDATE_Command(Order anOrder)
        {
            ...
            daMain.UpdateCommand = new SqlCommand("UPDATE Orders SET CustomerID = @CustomerID, OrderDate = @OrderDate, TotalCost = @TotalCost , OrderStatus = @OrderStatus  " + "WHERE OrderID = @Original_OrderID", cnMain);
